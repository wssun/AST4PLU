...
def build_example(ast, tokenizer, args):
...
class TextDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        for idx in range(i*self.batch_size, (i+1)*self.batch_size):
            trees_inputs1.append(build_example(self.examples[idx].tree1, self.tokenizer, self.args))
            trees_inputs2.append(build_example(self.examples[idx].tree2, self.tokenizer, self.args))
...
def train(args, train_dataset, eval_dataset, model):
    ...
    early_stopping_flag = 0    # default:0
...
def main():
    ...
    parser.add_argument("--output_dir", default="./binarytree", type=str,
                        help="The output directory where checkpoints will be written.")
    parser.add_argument("--model", default="2-ary", type=str, help="child-sum/2-ary")
    ...
    parser.add_argument("--tokenizer_name_or_path", default='../dataset/codebert-base', type=str)  # microsoft/codebert-base     ../dataset/codebert-base
