...
def main():
    ...
    parser.add_argument("--code_size", default=300, type=int,help="length of code/ast/sbt")
    parser.add_argument("--sbt_size", default=1500, type=int, help="used when input_type is mix, length of sbt-token")
    ...
    parser.add_argument("--input_type", default='bfs', type=str,
                        help="func/bfs/sbt/mix, corresponding to code/ast bfs sequence/sbt sequence/code+(sbt-token)")
