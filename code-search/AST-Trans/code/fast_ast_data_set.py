...
class FastASTDataSet(BaseASTDataSet):
    ...
    def convert_ast_to_edges(self):
        ...
        for i in tqdm(range(self.data_set_len)):
            ...
            nl_ids, nl_mask = self.convert_nl_to_tensor(nl, self.tokenizer)

            item = Data(ast_ids=ast_ids,
    ...
    def __getitem__(self, index):
        ...
        ast_ids = data.ast_ids
        par_edges = data.par_edges
        bro_edges = data.bro_edges
        nl_ids = data.nl_ids
        nl_mask = data.nl_mask

        return ast_ids, par_edges, bro_edges, nl_ids, nl_mask
