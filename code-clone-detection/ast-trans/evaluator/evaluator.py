...
def main():
    ...
    parser.add_argument('--answers', '-a', default='..\\dataset\\test.txt', help="filename of the labels, in txt format.")
    parser.add_argument('--predictions', '-p', default='predictions.txt', help="filename of the leaderboard predictions, in txt format.")
