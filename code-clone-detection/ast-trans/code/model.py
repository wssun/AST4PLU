...
from components import Embeddings, _get_clones, FastRelEmbeddings, FeedForward, SublayerConnection
from base_seq2seq import BaseTrans
from components import DecoderLayer, BaseDecoder, Generator
from fast_attn import FastMultiHeadedAttention


class FastASTTrans(BaseTrans):
    def __init__(self, vocab_size, hidden_size, par_heads, num_heads,
                 max_rel_pos, pos_type, num_layers, dim_feed_forward, dropout):
        super(FastASTTrans, self).__init__(hidden_size)
